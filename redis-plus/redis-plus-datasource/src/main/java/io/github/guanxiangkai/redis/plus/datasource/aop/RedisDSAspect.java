package io.github.guanxiangkai.redis.plus.datasource.aop;

import io.github.guanxiangkai.redis.plus.core.aop.RedisPlusAspectOrder;
import io.github.guanxiangkai.redis.plus.datasource.RedisDataSourceContext;
import io.github.guanxiangkai.redis.plus.datasource.annotation.RedisDS;
...
public class RedisDSAspect {
    ...
    @Around("!@annotation(io.github.guanxiangkai.redis.plus.datasource.annotation.RedisDS) "
            + "&& @within(redisDS)")
