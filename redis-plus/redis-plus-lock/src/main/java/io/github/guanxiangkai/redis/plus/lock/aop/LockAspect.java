package io.github.guanxiangkai.redis.plus.lock.aop;
...
import io.github.guanxiangkai.redis.plus.lock.annotation.RedisLock;
import io.github.guanxiangkai.redis.plus.lock.annotation.RedisReadLock;
import io.github.guanxiangkai.redis.plus.lock.annotation.RedisWriteLock;
import io.github.guanxiangkai.redis.plus.lock.event.LockAcquiredEvent;
import io.github.guanxiangkai.redis.plus.lock.event.LockFailedEvent;
import io.github.guanxiangkai.redis.plus.lock.event.LockReleasedEvent;
import io.github.guanxiangkai.redis.plus.lock.impl.RedisLockFactory;
import io.github.guanxiangkai.redis.plus.lock.spi.LockEventListener;
import io.github.guanxiangkai.redis.plus.lock.spi.LockEventPublisher;
import io.github.guanxiangkai.redis.plus.lock.spi.LockFailureHandler;
...
public class LockAspect {
    ...
    private Object doWithLock(ProceedingJoinPoint pjp, DistributedLock lock,
        ...
        String lockKey = definition.name();
            return observer.observe(RedisPlusObservationType.LOCK,
                ...
                ObservationTags.lockKey(lockKey),
                () -> {
                    ...
                    try {
                        ...
                        unlock(lock, lockKey, businessEx);
    ...
    private void unlock(DistributedLock lock, String lockKey, Throwable businessEx) {
        try {
            lock.unlock();
