...
public interface LockFailureHandler {
    ...
    /**
     * 锁获取失败时抛出 {@link io.github.guanxiangkai.redis.plus.core.exception.RedisLockException}（默认行为）
     */
    static LockFailureHandler throwException() {
        return definition -> {
            throw new io.github.guanxiangkai.redis.plus.core.exception.RedisLockException(
