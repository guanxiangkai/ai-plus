package io.github.guanxiangkai.redis.plus.cache.spi;
 ...
 * 缓存指标采集 SPI
 *
 * <p>提供比 {@link io.github.guanxiangkai.redis.plus.core.metrics.RedisPlusMetrics} 更细粒度的
 * 缓存专属指标接口，供 {@link io.github.guanxiangkai.redis.plus.cache.ThreeLevelCacheTemplate}
 * 在缓存各个阶段调用。
 *
