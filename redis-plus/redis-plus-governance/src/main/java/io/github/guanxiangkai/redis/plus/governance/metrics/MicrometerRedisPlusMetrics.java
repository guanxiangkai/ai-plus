package io.github.guanxiangkai.redis.plus.governance.metrics;
 ...
 * 由 {@code redis-plus-starter} 自动替换默认的 {@link io.github.guanxiangkai.redis.plus.core.metrics.NoopRedisPlusMetrics}。
 *
