package io.github.guanxiangkai.redis.plus.enhance.bloom.impl;
...
public class RedisBitmapBloomFilter<E> implements BloomFilter<E> {
    ...
    public RedisBitmapBloomFilter(String name,
        ...
        this(name, expectedCount, falsePositive, version, hashProvider,
                redisTemplate, new DefaultRedisScriptExecutor(redisTemplate));
    }
    ...
    public boolean mightContain(E element) {
        ...
        Long result = scriptExecutor.execute(CHECK_SCRIPT, Long.class, Collections.singletonList(redisKey), (Object[]) args);
    ...
    public void put(E element) {
        long[] positions = positions(element);
        String[] args = toStringArgs(positions);
        scriptExecutor.execute(SET_SCRIPT, Long.class, Collections.singletonList(redisKey), (Object[]) args);
    }
