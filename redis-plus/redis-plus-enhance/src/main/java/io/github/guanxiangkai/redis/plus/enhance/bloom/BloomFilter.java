package io.github.guanxiangkai.redis.plus.enhance.bloom;

/**
 * 布隆过滤器统一抽象
 *
 * <p>用于在缓存查询前快速过滤"肯定不存在"的 Key，从根源上防止缓存穿透。
 * 默认实现为基于 Redis SETBIT/GETBIT 的 {@link io.github.guanxiangkai.redis.plus.enhance.bloom.impl.RedisBitmapBloomFilter}。
 *
 * @param <E> 元素类型
 */
